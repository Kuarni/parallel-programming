...
class ParallelFloyd {
    ...
    fun simpleTest() {
        ...
        assertEquals(10, floydParallel(graph, 0, 3))
    }
    ...
    fun load100Test() {
        ...
        assertEquals(9, floydParallel(graph, 0, 99))
    }
    ...
    fun load1000Test() {
        ...
        assertEquals(3, floydParallel(graph, 0, 999))
    }
    ...
    fun load10000Test() {
        ...
        assertEquals(25, floydParallel(graph, 0, 9999))
    }
...
//
//        assertEquals(21, floydParallel(graph, 0, 99999))
//    }
}
